  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-sm p-6">
        <h2 className="text-lg font-bold text-gray-900 mb-6 uppercase tracking-wide">POPULAR POSTS</h2>
          ...
          {popularPosts.map((post) => (
            <div key={post.id} className="flex space-x-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <h3 className="text-sm font-medium text-gray-900 leading-tight hover:text-green-600 cursor-pointer transition-colors line-clamp-2">
                  {post.title}
                </h3>
              </div>
            </div>
      ...
      <div className="bg-white rounded-lg shadow-sm p-6">
        <h2 className="text-lg font-bold text-gray-900 mb-6 uppercase tracking-wide">TAG CLOUD</h2>
        <div className="flex flex-wrap gap-2">
          {tags.map((tag) => (
            <button
              key={tag}
              className="px-3 py-1 text-sm bg-green-100 text-green-800 rounded hover:bg-green-200 hover:text-green-900 transition-colors"
            >
              {tag}
            </button>
          ))}
      ...
      {/* Twitter */}
      <div className="bg-white rounded-lg shadow-sm p-6">
        <h2 className="text-lg font-bold text-gray-900 mb-6 uppercase tracking-wide">TWITTER</h2>
        ...
        <div className="space-y-4">
          {tweets.map((tweet) => (
            <div key={tweet.id} className="text-sm">
              <p className="text-black leading-relaxed mb-2">&ldquo;{tweet.content}&rdquo;</p>
              <div className="text-xs text-green-700 font-medium">{tweet.time}</div>
            </div>
          ))}
        </div>
      </div>
      ...
      {/* Instagram */}
      <div className="bg-white rounded-lg shadow-sm p-6">
        <h2 className="text-lg font-bold text-gray-900 mb-6 uppercase tracking-wide">INSTAGRAM</h2>
      ...
      {/* Subscribe */}
      <div className="bg-white rounded-lg shadow-sm p-6">
        <h2 className="text-lg font-bold text-gray-900 mb-6 uppercase tracking-wide">АБОНИРАЙ СЕ</h2>
      ...
      {/* About Me */}
      <div className="bg-white rounded-lg shadow-sm p-6">
        <h2 className="text-lg font-bold text-gray-900 mb-6 uppercase tracking-wide">ABOUT ME</h2>
        <div className="text-center">
      ...
      {/* Follow Me */}
      <div className="bg-white rounded-lg shadow-sm p-6">
        <h2 className="text-lg font-bold text-gray-900 mb-6 uppercase tracking-wide">FOLLOW ME</h2>
        <div className="flex justify-center space-x-4">
          ...
          <a href="#" aria-label="Like" className="text-gray-400 hover:text-red-500 transition-colors">
      ...
      <div className="bg-white rounded-lg shadow-sm overflow-hidden">
        <h2 className="text-lg font-bold text-gray-900 mb-4 p-6 pb-0 uppercase tracking-wide">BANNER</h2>
        <div className="relative">
          <img
