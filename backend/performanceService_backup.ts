...
export class PerformanceService {
  ...
  async preloadCriticalData(): Promise<void> {
    ...
    await Promise.all([
      this.optimizedQuery('popular-articles', criticalQueries[0], 'articles:popular', 'articles'),
      this.optimizedQuery('recent-articles', criticalQueries[1], 'articles:recent', 'articles'),
      this.optimizedQuery('active-series', criticalQueries[2], 'series:active', 'series'),
      this.optimizedQuery('categories', criticalQueries[3], 'articles:categories', 'static')
    ])
  }
